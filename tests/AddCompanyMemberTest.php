...
class AddCompanyMemberTest extends OrchestraTestCase
{
    ...
    public function test_company_members_can_be_added()
    {
        ...
        $this->assertInstanceOf(Membership::class, $company->users[0]->membership);
